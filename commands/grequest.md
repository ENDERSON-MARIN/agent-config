...
4. Crie o PR com `gh pr create --title "<título>" --body "<resumo>"`. Use `$ARGUMENTS` como título se fornecido; caso contrário, sugira um título no padrão conventional em minúsculas.
